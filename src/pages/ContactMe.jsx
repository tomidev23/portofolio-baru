      ...
      <>
        ...
        >
          <Popover.Panel className="p-4 w-full flex flex-col gap-1.5">
            <a
              href="https://www.linkedin.com/in/tomingselingga/"
              className="text-[#607B96] hover:text-white inline-flex items-center gap-2.5 transition-colors"
              target="_blank"
              rel="noreferrer"
            >
              <GrLinkedinOption />
              <span>Tomingse lingga</span>
            </a>
            <a
              href="mailto:tomingselingga2512@gmail.com"
              className="text-[#607B96] hover:text-white inline-flex items-center gap-2.5 transition-colors"
            >
              <MdEmail />
              <span>tomingselingga</span>
            </a>
            <a
              href="https://youtube.com/@tomingselingga"
              className="text-[#607B96] hover:text-white inline-flex items-center gap-2.5 transition-colors"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://wakatime.com/@Tomidev23"
              className="text-[#607B96] hover:text-white inline-flex items-center gap-2.5 transition-colors"
              target="_blank"
              rel="noreferrer"
            >
